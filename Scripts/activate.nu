...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Andre\PycharmProjects\emp_graduation_project_be'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Andre\PycharmProjects\emp_graduation_project_be\Scripts\deactivate.nu'
